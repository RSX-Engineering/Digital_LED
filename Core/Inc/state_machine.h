...
#define SLEEP(MILLIS) do { state_machine_.sleep_until_ = SystickTime10us + (MILLIS); while (SystickTime10us/100 < state_machine_.sleep_until_) YIELD(); } while(0)
